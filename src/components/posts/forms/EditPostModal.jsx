import { Avatar, Box, Button, CloseButton, Divider, Flex, Modal, ModalBody, ModalCloseButton, ModalContent, ModalOverlay, Textarea, useColorModeValue } from "@chakra-ui/react";
import { useDispatch, useSelector } from "react-redux";
import { MdPublic, MdOutlineEmojiEmotions as MdEmoji } from "react-icons/md";
import { RiImageAddLine } from "react-icons/ri";
import EmojiPicker from "emoji-picker-react";
import { toast } from "react-toastify";
import { editPostUser, getPosts } from "../../../store/slice/postSlice";
...
function EditPostModal({ isOpen, onClose, post }) {
    ...
    const handleUpdatePost = () => {
        ...
        dispatch(editPostUser(editPostBody))
            .unwrap()
            .then((data) => {
                // ถ้าการล็อกอินสำเร็จ
                dispatch(getPosts());
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <ModalOverlay />
            <ModalContent my={65} maxWidth={"60%"} minWidth={"50%"} width="60%" height="auto" boxShadow="xl" rounded="lg" border="none">
                <ModalBody className="flex flex-col p-4">
                    ...
                    >
                        ...
                        <Button onClick={handleUpdatePost} isDisabled={isDisabled}>
                            แก้ไขโพสต์
                        </Button>
                    </Flex>
